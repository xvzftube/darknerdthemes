...
#'   nerd_theme()
#'
nerd_theme_xvzf <- function(legend_right = FALSE,
                            base_size = 12,
                            base_family = "",
                            # base_family = "SauceCode Pro Nerd Font",
                            base_line_size = base_size / 170,
                            base_rect_size = base_size / 170) {
  half_line <- base_size / 2
  grid_line_color <- nerd_colors("xvzf-white")
  grid_line_size <- 0.2
  title_text_color <- nerd_colors("xvzf-white")
  other_text_color <- nerd_colors("xvzf-white")
  panel_background <- nerd_colors("xvzf-background")
  font_family <- "SauceCode Pro Nerd Font"
